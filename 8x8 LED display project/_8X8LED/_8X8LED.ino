...
#include <avr/pgmspace.h>
    ...
    char incomebyte;
    int scrollSpeed = 100;
    char text[100] = "DUET  "; // Initial text message
    int brightness = 15;
    int count = 0;
    char indicator;
...
void loop() {
  ...
  if(Serial.available()>0){
      indicator = Serial.read();   // Starts reading the serial port, the first byte from the incoming data
